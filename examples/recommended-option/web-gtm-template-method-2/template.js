...
function updateConsent(data) {
  ...
  if (
    data.hasOwnProperty('gcmAnalyticsConsent') ||
    data.hasOwnProperty('manualAnalyticsConsent')
  ) {
  ...
  if (
    data.hasOwnProperty('gcmMarketingConsent') ||
    data.hasOwnProperty('manualMarketingConsent')
  ) {
